...
# Example of reading a v2+ schema alert
data "signoz_alert" "v2_alert" {
  id = "6"
}

output "v2_alert_schema_version" {
  value = data.signoz_alert.v2_alert.schema_version
}

output "v2_alert_notification_settings" {
  value = data.signoz_alert.v2_alert.notification_settings
}
```
