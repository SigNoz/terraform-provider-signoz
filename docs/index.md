...
- `http_timeout` (String) Specifies the timeout for the HTTP requests made to SigNoz as a Go duration string (e.g. "35s"). Also, you can set it using environment variable SIGNOZ_HTTP_TIMEOUT. If not set, it defaults to 35s.
