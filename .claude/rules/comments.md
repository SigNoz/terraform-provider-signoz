...
A step's `name`, `uses`, and inputs already say what it does — don't narrate them. Comment only a constraint a future edit would silently break, and keep it to a line.
