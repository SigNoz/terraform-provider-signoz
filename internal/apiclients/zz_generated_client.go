...
type CreateNotificationChannelJSONRequestBody = apitypes.AlertmanagertypesPostableNotificationChannel

// UpdateNotificationChannelJSONRequestBody defines body for UpdateNotificationChannel for application/json ContentType.
type UpdateNotificationChannelJSONRequestBody = apitypes.AlertmanagertypesUpdatableNotificationChannel
...
type ClientInterface interface {
	...
	DeleteNotificationChannel(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetNotificationChannel request
	GetNotificationChannel(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// UpdateNotificationChannelWithBody request with any body
	UpdateNotificationChannelWithBody(ctx context.Context, id string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdateNotificationChannel(ctx context.Context, id string, body UpdateNotificationChannelJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	CreateUserRole(ctx context.Context, body CreateUserRoleJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// DeleteUserRole request
	DeleteUserRole(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetUserRole request
	GetUserRole(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) DeleteNotificationChannel(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetNotificationChannel(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) UpdateNotificationChannelWithBody(ctx context.Context, id string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) UpdateNotificationChannel(ctx context.Context, id string, body UpdateNotificationChannelJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) CreateUserRoleWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateUserRoleRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateUserRole(ctx context.Context, body CreateUserRoleJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateUserRoleRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) DeleteUserRole(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteUserRoleRequest(c.Server, id)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetUserRole(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetUserRoleRequest(c.Server, id)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewCreateAuthDomainRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/api/v2/auth_domains")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewDeleteAuthDomainRequest(server string, id string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/api/v2/auth_domains/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewCreateNotificationChannelRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/api/v2/notification_channels")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewDeleteNotificationChannelRequest(server string, id string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v2/notification_channels/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewGetNotificationChannelRequest(server string, id string) (*http.Request, error) {
	var err error
...
func NewUpdateNotificationChannelRequest(server string, id string, body UpdateNotificationChannelJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewUpdateNotificationChannelRequestWithBody(server string, id string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewCreateUserRoleRequest(server string, body CreateUserRoleJSONRequestBody) (*http.Request, error) {
	...
	bodyReader = bytes.NewReader(buf)
	return NewCreateUserRoleRequestWithBody(server, "application/json", bodyReader)
}

// NewCreateUserRoleRequestWithBody generates requests for CreateUserRole with any type of body
func NewCreateUserRoleRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v2/user_roles")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewDeleteUserRoleRequest(server string, id string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v2/user_roles/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetUserRoleRequest generates requests for GetUserRole
func NewGetUserRoleRequest(server string, id string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	DeleteNotificationChannelWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*DeleteNotificationChannelResponse, error)

	// GetNotificationChannelWithResponse request
	GetNotificationChannelWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*GetNotificationChannelResponse, error)

	// UpdateNotificationChannelWithBodyWithResponse request with any body
	UpdateNotificationChannelWithBodyWithResponse(ctx context.Context, id string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateNotificationChannelResponse, error)

	UpdateNotificationChannelWithResponse(ctx context.Context, id string, body UpdateNotificationChannelJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateNotificationChannelResponse, error)
	...
	CreateUserRoleWithResponse(ctx context.Context, body CreateUserRoleJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateUserRoleResponse, error)

	// DeleteUserRoleWithResponse request
	DeleteUserRoleWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*DeleteUserRoleResponse, error)

	// GetUserRoleWithResponse request
	GetUserRoleWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*GetUserRoleResponse, error)
...
type CreateNotificationChannelResponse struct {
	...
	HTTPResponse *http.Response
	JSON201      *struct {
		Data   apitypes.AlertmanagertypesGettableNotificationChannel `json:"data"`
		Status string                                                `json:"status"`
	}
	JSON400 *apitypes.RenderErrorResponse
	JSON401 *apitypes.RenderErrorResponse
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r DeleteNotificationChannelResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// Status returns HTTPResponse.Status
func (r CreateUserRoleResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r CreateUserRoleResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r CreateUserRoleResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r DeleteUserRoleResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
type GetUserRoleResponse struct {
	...
	HTTPResponse *http.Response
	JSON200      *struct {
		Data   apitypes.AuthtypesUserRole `json:"data"`
		Status string                     `json:"status"`
	}
	JSON400 *apitypes.RenderErrorResponse
	JSON401 *apitypes.RenderErrorResponse
...
// Status returns HTTPResponse.Status
func (r GetUserRoleResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetUserRoleResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r GetUserRoleResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
func (c *ClientWithResponses) DeleteNotificationChannelWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*DeleteNotificationChannelResponse, error) {
...
func (c *ClientWithResponses) GetNotificationChannelWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*GetNotificationChannelResponse, error) {
...
func (c *ClientWithResponses) UpdateNotificationChannelWithBodyWithResponse(ctx context.Context, id string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateNotificationChannelResponse, error) {
...
func (c *ClientWithResponses) UpdateNotificationChannelWithResponse(ctx context.Context, id string, body UpdateNotificationChannelJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateNotificationChannelResponse, error) {
...
func (c *ClientWithResponses) CreateUserRoleWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateUserRoleResponse, error) {
	rsp, err := c.CreateUserRoleWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateUserRoleResponse(rsp)
}

func (c *ClientWithResponses) CreateUserRoleWithResponse(ctx context.Context, body CreateUserRoleJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateUserRoleResponse, error) {
	rsp, err := c.CreateUserRole(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateUserRoleResponse(rsp)
...
func (c *ClientWithResponses) DeleteUserRoleWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*DeleteUserRoleResponse, error) {
	rsp, err := c.DeleteUserRole(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
...
// GetUserRoleWithResponse request returning *GetUserRoleResponse
func (c *ClientWithResponses) GetUserRoleWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*GetUserRoleResponse, error) {
	rsp, err := c.GetUserRole(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetUserRoleResponse(rsp)
}
...
// ParseCreateUserRoleResponse parses an HTTP response from a CreateUserRoleWithResponse call
func ParseCreateUserRoleResponse(rsp *http.Response) (*CreateUserRoleResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
...
// ParseGetUserRoleResponse parses an HTTP response from a GetUserRoleWithResponse call
func ParseGetUserRoleResponse(rsp *http.Response) (*GetUserRoleResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
